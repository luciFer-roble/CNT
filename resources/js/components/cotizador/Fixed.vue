        ...
        <div class="d-flex justify-content-center">
          <svg version="1.1"
                    ...
                    <g>
                      <g>
                        <g>
                          <path d="M37.2,58.9L37.2,58.9c-0.8,0-1.4-0.2-1.7-0.3c-6.7-2.3-13.4-8.3-19.9-17.9
                      ...
                      <path d="M46.1,1.1c-0.7-0.1-1.5-0.2-2.2-0.2c-6.3,0-11.4,5.1-11.4,11.4c0,4.2,2.3,7.9,5.7,9.9
    ...
    <b-row>
      <b-col>
        <b-form-checkbox-group
          ...
          >
          <template>
            <b-form-checkbox v-for="(plan, index) in plans" :value="plan" class="table-checkbox" :key="index">
              <b-row>
                <b-col cols="9">{{plan.name}}</b-col>
                <b-col cols="3" class="text-right"><strong>{{plan.price}}$*</strong></b-col>
              </b-row>
            </b-form-checkbox>
          </template>
        </b-form-checkbox-group>
    ...
    data () {
      return {
        ...
        plans: [
          ...
          {
            name: 'Noches y fines de semana sin límites',
            price: 3.36
          },
        ]
      }
